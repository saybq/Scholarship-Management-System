...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-6">
        ...
        <div class="bg-white border rounded-xl p-6 shadow">
            ...
            <form action="../../../controllers/sponsor/updateprofile.php" method="POST" class="space-y-4">
                ...
                <div class="flex justify-end">
                    <button class="px-4 py-2 bg-blue-600 text-white rounded flex items-center gap-2 text-sm hover:bg-green-700">
