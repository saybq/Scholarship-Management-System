    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 text-sm">Manage your sponsor account information</p>
            </div>
            ...
            <div class="bg-white border rounded-xl p-6 shadow">
                ...
                <form  id="sponsorProfileForm" action="../../../controllers/sponsor/updateprofile.php" method="POST" class="space-y-4">
                    ...
                    <!-- SPONSOR COMPANY -->
                    <div>
                        <label class="block text-sm font-semibold">Sponsor Company</label>
                        <input 
                            disabled
                            type="text" 
                            name="sponsor_company"
                            class="w-full border p-2 rounded mt-1 text-xs"
                            value="<?= htmlspecialchars($data['sponsor_company'] ?? '') ?>">
                    </div>
            ...
            <div class="flex justify-end mt-6 mb-20">
                <button form="sponsorProfileForm" class="px-4 py-2 bg-blue-600 text-white rounded flex items-center gap-2 text-sm hover:bg-green-700">
