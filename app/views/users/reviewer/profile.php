<?php
    ...
    // FETCH ADMISSION STAFF DATA
    $sql = "SELECT * FROM admissionstaff WHERE reviewer_ID = ?";
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 text-sm">Manage your admission staff account information</p>
            </div>
            ...
            <div class="bg-white border rounded-xl p-6 mb-6 shadow">
                ...
                <form id="admissionProfileForm" action="../../../controllers/reviewer/updateprofile.php" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="department" class="border p-2 rounded text-xs w-60">
            ...
            <div class="flex justify-end mt-6">
                <button form="admissionProfileForm"
