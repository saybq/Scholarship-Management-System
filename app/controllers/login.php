<?php
    require_once __DIR__ . '/../core/dbconnection.php'; // Importing Database Connection
    session_start();                                    // Start Seesion for SESSION Variables
    ...
    function tryLogin($pdo, $table, $userIdField, $role, $username, $password) {   // Function for logging in
    ...
    if (tryLogin($pdo, "student", "ID", "student", $username, $password)) {                    // The IFs statements filter what kind of users are they
    ...
    header("Location: /Scholarship/app/views/auth/login.php?error=1");                       // Fallback if they enter incorrect credential
    exit;
